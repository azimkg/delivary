    ...
    <div className="containerrr">
      ...
      <div className="categories_cards">
        ...
        <a href="#" className="cat-button">
          <img
            className="cat__desktop cat__img"
        ...
        <a href="#" className="cat-button">
          <img
            className="cat__desktop categories_card-img-1"
            src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
            alt=""
          />
        </a>
        ...
        <div className="categories_card-1">
          <img
            className="cat__desktop categories_card-img-1"
            src="https://images.unsplash.com/photo-1572449043416-55f4685c9bb7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"
            alt=""
          />
        </div>
        <div className="categories_card-1">
        ...
        <div className="categories_card-1">
          <img
            className="cat__desktop categories_card-img-1"
            src="https://images.unsplash.com/photo-1518510227856-30619d542ea9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"
            alt=""
          />
        </div>
